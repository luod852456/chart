...
//                    buffer.buffer[j + 3], mRenderPaint);
            ...
            float r = (buffer.buffer[j + 2] - buffer.buffer[j]) / 10;
//            c.drawRoundRect(rectF,r,r,mRenderPaint);
...
//                c.drawRoundRect(rectF,r,r,mBarBorderPaint);
...
//
            float r = (mBarRect.right - mBarRect.left) / 10;
            Path path = new Path();
            path.addRoundRect(mBarRect,
                    new float[]{
                            r, r,
                            r, r,
                            0, 0,
...
//        float rTop = bar.top - bar.right + bar.left;
//        high.setDraw(bar.centerX(), rTop);
    }
